    ...
    <SafeAreaView style={[styles.safeArea, { backgroundColor: activeTheme.background }]}>
      ...
      <View style={styles.content}>
        ...
        <View style={styles.logoContainer}>
          <Text style={[styles.logo, { color: activeTheme.textPrimary }]}>LOKAWAZ</Text>
        ...
        <View style={styles.form}>
          ...
          <TouchableOpacity 
            ...
            onPress={handleLogin}
          >
            {loading ? <ActivityIndicator color="#FFF" /> : <Text style={styles.mainButtonText}>INITIATE SESSION</Text>}
          </TouchableOpacity>
